  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        {/* Features / Tech */}
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-center text-slate-900 dark:text-white mb-12">Powered by RJ</h2>
        ...
        {/* Team / Stats Dummy Placeholder */}
        <div className="text-center py-12 border-t border-slate-200 dark:border-white/10">
          <p className="text-slate-400 text-sm">Founded in 2024 by RJ.</p>
        </div>
      </div>
    </div>
  );
