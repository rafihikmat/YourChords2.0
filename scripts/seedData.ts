...
// NOTE: Run this script using ts-node or by compiling to JS.
// Ensure environment variables are set or replace placeholders below.

const supabaseUrl = process.env.VITE_SUPABASE_URL || 'https://qgfktfjwnpycremegeme.supabase.co';
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.VITE_SUPABASE_ANON_KEY || 'sb_secret_dcYBrVWeTtFU539uFywVBQ_L6fe-elZ';
