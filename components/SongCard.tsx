...
export default function SongCard({ song }: { song: Song }) {
  const coverUrl = song.cover_url || "https://images.unsplash.com/photo-1511192336575-5a79af67a629?q=80&w=800&auto=format&fit=crop";

  return (
    <Link href={`/chord/${song.id}`} className="block flex-shrink-0 w-36 sm:w-44 md:w-48 lg:w-56 group">
