...
import { Search, Menu, X, Disc3, LogOut, User as UserIcon } from "lucide-react";
    ...
    >
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 h-16 flex items-center justify-between gap-3 md:gap-6">
        ...
        <form onSubmit={handleSearch} className="relative group flex-1 max-w-sm hidden sm:block">
          <button type="submit" className="absolute inset-y-0 left-3 flex items-center z-10 text-slate-500 group-focus-within:text-primary transition-colors cursor-pointer">
