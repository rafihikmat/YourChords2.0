            ...
            <div className="max-w-[1400px] mx-auto px-6 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <Link
                            href="/"
                            className="inline-flex items-center gap-2.5 text-xl font-black tracking-tight text-white group"
                        >
                            ...
                            <span className="text-white font-extrabold text-2xl tracking-tight">
                                Your<span className="text-primary-light">
                                    Chords
                                </span>
                        ...
                        <p className="text-xs text-slate-400 leading-relaxed max-w-sm font-medium">
                            Belajar, latih, dan mainkan ribuan chord & lirik
                            lagu favoritmu secara real-time. Platform musik
                            AI-Powered terdepan untuk musisi Indonesia.
                        </p>
                            ...
                            <li>
                                <a
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault();
                                        alert(
                                            "Pusat bantuan: Hubungi admin jika butuh panduan.",
                                        );
                                    }}
                    ...
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-2 text-xs font-medium text-slate-400">
                            ...
                            <li>
                                <a
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault();
                                        alert(
                                            "Kebijakan Privasi: Data Anda aman & terlindungi.",
                                        );
                                    }}
                            ...
                            <li>
                                <a
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault();
                                        alert(
                                            "Syarat & Ketentuan: Penggunaan gratis untuk seluruh musisi.",
                                        );
                                    }}
                                    className="hover:text-emerald-400 transition-colors cursor-pointer"
                                >
                            ...
                            <li>
                                <Link
                                    href="/admin"
                                    className="hover:text-emerald-400 transition-colors font-bold text-slate-300 flex items-center gap-1"
                                >
                ...
                <div className="pt-8 border-t border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-500">
                    <p>
                        ...
                        YourChords. All rights reserved.
                    </p>

                    <p className="flex items-center gap-1.5 text-slate-400">
                        Made with <span className="text-base">🤘</span>{" "}
                        in Indonesia for Musicians Worldwide.
                    </p>
                </div>
            </div>
        </footer>
